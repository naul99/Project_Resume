...
<body class="h-full">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a wire:navigate href="{{route('edu')}}"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Education</a>
                                <a wire:navigate href="{{route('ove')}}"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Overview</a>
                                <a wire:navigate href="{{route('exp')}}"
    ...
    <script>
        ...
        document.addEventListener('click', (event) => {
            if (myDiv.style.display === 'block' && !myDiv.contains(event.target)) {
